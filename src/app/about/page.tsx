...
export default function AboutPage() {
  return <main className="bg-white text-[#141414]"><SiteHeader />
    ...
    <section className="px-5 pb-20 md:px-8 md:pb-28"><div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center"><Reveal><div className="relative aspect-[4/3] overflow-hidden rounded-lg"><Image alt="Sample photography crew preparing a professional studio shoot" className="object-cover" fill sizes="(max-width: 1024px) 100vw, 60vw" src="https://images.pexels.com/photos/19102538/pexels-photo-19102538.jpeg?auto=compress&cs=tinysrgb&w=1600" /><span className="absolute bottom-4 left-4 rounded-full bg-black/70 px-4 py-2 text-xs text-white backdrop-blur">Sample crew visual · replace with Studio 7 team photo</span></div></Reveal><Reveal delay={100}><div><p className="eyebrow">The story</p><h2 className="display-serif mt-4 text-4xl leading-tight md:text-5xl">Different events. One thoughtful way of seeing them.</h2><div className="mt-6 grid gap-5 leading-7 text-black/60"><p>Studio 7 Production works across weddings, engagements, corporate events, private celebrations and live productions. Every assignment begins by understanding the people involved, the flow of the day and what matters most after the event is over.</p><p>The team combines a calm on-site approach with organised production. The result is coverage that feels natural, polished and personal, whether it is an intimate ceremony or a multi-camera event.</p></div></div></Reveal></div></section>
