...
export default function FaqPage() { return <main className="bg-white text-[#141414]"><SiteHeader /><section className="px-5 pb-10 pt-28 text-center md:px-8 md:pb-12 md:pt-32"><p className="eyebrow">FAQ</p><h1 className="display-serif mx-auto mt-3 max-w-3xl text-4xl md:text-6xl">A few things you may want to know.</h1></section><section className="px-5 pb-24 md:px-8"><div className="mx-auto max-w-4xl"><FaqAccordion items={faqs} /></div><div className="mt-14 text-center"><Link className="premium-button inline-flex items-center gap-2 rounded-full bg-[#141414] px-7 py-3.5 text-sm font-semibold text-white" href="/inquiry">Check your date <ArrowRight size={17} /></Link></div></section><SiteFooter /></main>; }
