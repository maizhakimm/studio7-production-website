...
export function HeroReel() {
  ...
  return (
    <div className="hero-reel relative mx-auto mt-10 aspect-[5/4] w-full max-w-6xl overflow-hidden rounded-lg bg-[#f5f4f1] sm:aspect-[16/9] lg:mt-14 lg:max-h-[610px]">
